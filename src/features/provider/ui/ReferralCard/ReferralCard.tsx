...
const avatarColors = ["bg-sage", "bg-lavender", "bg-coral/30", "bg-amber-light"];
...
export function ReferralCard({
  ...
  const avatarColor = avatarColors[patientName.charCodeAt(0) % avatarColors.length];
      ...
      <div className="flex w-full flex-1 flex-col gap-4 md:w-auto">
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <Typography size="body-sm" className="font-medium text-muted-foreground">
        ...
        <div className="mt-2">
          ...
          <Typography size="body-sm" className="leading-relaxed text-muted-foreground">
