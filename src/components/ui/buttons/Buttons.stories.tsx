  ...
  render: () => (
    <div className="flex flex-col gap-8">
      <p className="text-sm text-gray max-w-md text-center">
        Hover over each button to see the enhanced hover effects with scale,
        shadow, and color transitions.
      </p>
      ...
      <div className="grid grid-cols-2 gap-6 items-center">
        ...
        <div className="flex flex-col items-center gap-3">
          ...
          <GhostButton className="bg-dark/8 scale-[1.02]">Ghost</GhostButton>
        </div>
      </div>
    </div>
  ),
    ...
    <div className="flex flex-col gap-8">
      <div className="flex flex-col gap-2">
        ...
        <div className="flex gap-4">
          <PrimaryButton shimmer showArrow>
            Start Free Check-in
          </PrimaryButton>
