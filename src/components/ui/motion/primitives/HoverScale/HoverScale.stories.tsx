...
export const Default: Story = {
  args: {
    className: "flex h-12 w-12 items-center justify-center rounded-full bg-coral text-white",
...
export const Disabled: Story = {
  args: {
    disabled: true,
    className: "flex h-12 w-12 items-center justify-center rounded-full bg-gray/30 text-gray cursor-not-allowed",
    children: <Send className="h-5 w-5" />,
  },
};
