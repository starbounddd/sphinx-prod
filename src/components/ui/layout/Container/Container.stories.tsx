  ...
  render: () => (
    <div className="space-y-8 py-8">
      <Container size="narrow">
        <div className="rounded-lg bg-coral/20 p-4 text-center text-dark">Narrow</div>
      </Container>
      <Container>
        <div className="rounded-lg bg-sage p-4 text-center text-dark">Default</div>
      </Container>
      <Container size="wide">
        <div className="rounded-lg bg-lavender p-4 text-center text-dark">Wide</div>
      </Container>
    </div>
  ),
};
