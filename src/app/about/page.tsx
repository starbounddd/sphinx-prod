export default function AboutPage() {
    return (
      <main className="py-16 px-6 max-w-3xl mx-auto">
        <h1 className="bg-ring border-ring text-[50px] rounded-[var(--radius-4xl)] border-l-250 border-l-4 border-border pl-4 mb-6">About Sphinx</h1>
        <div className="bg-secondary rounded-[var(--radius-sms)]">
