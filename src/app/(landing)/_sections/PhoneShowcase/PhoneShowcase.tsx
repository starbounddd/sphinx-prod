...
import Iphone15Pro from "@/shared/ui/shadcn/iphone-15-pro";
import { Container, Section } from "@/shared/ui/layout";
import { Typography } from "@/shared/ui/typography";
import { ChatMessage } from "@/shared/ui/chat";
            ...
            <div className="h-[560px] w-[275px]">
              <Iphone15Pro>
                <div className="flex h-full flex-col items-center justify-center bg-linear-to-br from-cream to-sage px-6">
                  ...
                  <Typography size="h3" className="mb-2">Start</Typography>
                  <Typography size="body" color="muted" align="center">Share what&apos;s on your mind</Typography>
                </div>
              </Iphone15Pro>
            </div>
          </div>
              ...
              <Iphone15Pro>
                <div className="flex h-full flex-col bg-white px-4 pb-12 pt-10">
                  <div className="mb-4 text-center">
                    ...
                    <Typography size="h4" className="font-normal text-gray">Private & Secure</Typography>
                  </div>
                  ...
                  <div className="mt-3 flex items-center gap-2 rounded-2xl bg-lavender p-3">
                    <Typography size="body" as="span" color="muted" className="flex-1">Type here...</Typography>
              ...
              <Iphone15Pro>
                <div className="flex h-full flex-col items-center bg-linear-to-br from-lavender to-cream px-6 pt-12">
                  <div className="mb-4 flex h-14 w-14 items-center justify-center rounded-xl bg-coral-20">
                    <FileBarChart className="h-8 w-8 text-coral" strokeWidth={1.5} />
                  </div>
                  <Typography size="h3" className="mb-2">Report</Typography>
                  <Typography size="body" color="muted" align="center" className="mb-6">Structured insights</Typography>
                  <div className="w-full space-y-3">
                    <div className="rounded-xl bg-white p-3">
                      <Typography size="h4">Primary Symptoms</Typography>
                      <Typography size="body" color="muted">Anxiety, Stress</Typography>
                    </div>
                    <div className="rounded-xl bg-white p-3">
                      <Typography size="h4">Triggers</Typography>
                      <Typography size="body" color="muted">Work environment</Typography>
                    </div>
                  </div>
                </div>
              </Iphone15Pro>
